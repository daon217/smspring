...
<%--    slim이라는게 있으면 일부 제이쿼리 라이브러리가 빠져있어서 지웠음--%>
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    <script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0bc1bd177461e885b04962ec8febaabb&libraries=services"></script>
    <style>
        .fakeimg {
            height: 200px;
            background: #aaa;
    ...
    <div class="row">
        ...
        <c:choose>
            <c:when test="${center == null}">
                <jsp:include page="map/center.jsp"/>
            </c:when>
            <c:otherwise>
