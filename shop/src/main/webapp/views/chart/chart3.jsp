    ...
    const chart3 = {
        ...
        getData1:function(){
            $.ajax({
                url:'/chart3_1',
                success:(data)=>{
                    this.drawTotalSalesChart(data);
                },
                error:()=>{
                    alert('월별 매출 합계 데이터를 불러오는데 실패했습니다.');
                }
            });
        },
        getData2:function(){
            $.ajax({
                url:'/chart3_2',
                success:(data)=>{
                    this.drawAverageSalesChart(data);
                },
                error:()=>{
                    alert('월별 매출 평균 데이터를 불러오는데 실패했습니다.');
                }
            });
        },
